...
impl Editor {
    ...
    pub fn code_actions(&self) -> Option<impl Future<Output = Vec<CodeAction>>> {
            ...
            .map(|language_server| {
                ...
                let context = lsp::CodeActionContext {
                    diagnostics: doc
                        ...
                        .iter()
                        .filter(|&diag| {
                            diag.provider == language_server_id
                ...
                async move {
                    ...
                    let actions: Vec<_> = actions
                        ...
                        .map(move |action| CodeAction::lsp(language_server_id, action))
                        .collect();
